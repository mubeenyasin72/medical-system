    ...
    render() { 
        return ( <React.Fragment>
            <div class="container-fluid bg-white">
                <div class="row">
                    <div class="col-12">
                        <h6 class=""><span class="stat-chart-title-border">USER</span> STATISTICS</h6>
                    </div>
                </div>
                <div class="row pt-4">
                    <div class="col-7 col-sm-7 col-md-8 col-lg-9 col-xl-8">
                        <div class="row pt-3">
                            <Doughnut options={options} ref="chart" data={data} />
                        </div>
                    </div>
                    <div class="col-5 col-sm-5 col-md-4 col-lg-3 col-xl-4">
